...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <div
        className={`fixed md:relative z-50 md:z-auto h-full w-72 flex flex-col glass border-r border-border transition-transform duration-300 md:translate-x-0 ${
      ...
      >
        ...
        <div className="p-4 border-b border-border flex items-center justify-between">
          ...
          <button onClick={onClose} className="md:hidden text-muted hover:text-foreground cursor-pointer text-lg">
            ✕
          </button>
        </div>
